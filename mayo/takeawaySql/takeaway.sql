...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-05-2017 a las 18:08:28
...
(1, 'Entrantes', 'Las mejores ensaladas hechas exclusivamente con productos frescos de nuestro mercado local.', 'img/cats/entrantes.jpg'),
(2, 'Principales', 'Estos son nuestro platos principales, todos nuestros platos están hechos solo con productos frescos y naturales. Sin aditivos ni conservantes, envasados al vacío.', 'img/cats/principales.jpg'),
(3, 'Postres', 'Los mejores postres fríos, templados y calientes', 'img/cats/postres.jpg'),
(24, 'Entrantesdd', 'asdfasdf as', 'img/cats/postres.jpg'),
(27, 'dfasd', 'asdfasdf asd asd fasdf asdasdf ', 'img/cats/entrantes.jpg');
...
INSERT INTO `clientes` (`id`, `nombre`, `email`, `telf`, `direccion`, `cp`, `poblacion`, `password`, `fecha_alta`) VALUES
(1, 'Cliente Express', 'express@takeaway.cat', '666778899', 'Rambla castell, 14, 1º 1ª', '08800', '', '', '2017-02-08 17:26:25'),
(2, 'xavi', 'xavcet@gmail.com', '248892374', 'lasdjflajsdf lasdfj ', '08800', 'canyelles', 'fasdfkljhasdoÃ±', '2017-05-04 14:35:28');
...
(51, 'asdfsa', 'xavcet@gmail.com', 'asdfasdfa', '2017-04-07 16:21:16'),
(52, 'asdfsa', 'xavcet@gmail.com', 'asdfasdfa', '2017-04-07 16:22:08'),
(53, 'sdss', 'xavcet@gmail.com', 'fasddf', '2017-04-07 16:47:08'),
(54, 'dasfasd', 'xass@gmail.com', 'asdfasfasd', '2017-04-07 16:47:28');
...
(67, 1, '2017-05-03 13:54:47', '135.00'),
(68, 2, '2017-05-04 14:35:28', '144.00');
...
(2, 'Xató Vilanova', '5.00', 'Escarola de temporada limpiada y cuidadosamente seleccionada de nuestro propio huerto.', 'img/escarolaAnchoas.jpg', 1, 'on'),
(3, 'Fresas y Arándanos', '5.00', 'Texto de ejemplo', 'img/fresa_arandano.jpg', 3, 'on'),
(4, 'Canelones con Espinacas', '10.00', 'Canelones con espinacas frescas y bechamel con boletus.', 'img/canelones_espinacas.jpg', 2, 'on'),
(5, 'Ensalada CusCus', '6.00', 'Estilo marroquí hecha con productos exclusivos naturales.', 'img/ensalada_cuscus.jpg', 2, 'on'),
(6, 'Croquetas Bacalao', '10.00', '8 unidades de deliciosas croquetas de brandada de bacalao.', 'img/croquetasbacalao.jpg', 1, 'on'),
(7, 'Bravas', '4.00', 'Especialidad de la casa. Exquisitas bravas con patatas del pirineu.', 'img/bravas.jpg', 1, ''),
(8, 'Ensalada Capri', '3.00', 'Ensalada caprichosa con nueces y queso de cabra ecológico, un placer para el paladar. test', 'img/ensalada_pasta.jpg', 2, 'on');
